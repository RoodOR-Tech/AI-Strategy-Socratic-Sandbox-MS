...
<header>
  <div>
    <div class="brand-row">
      <img class="brand-logo" src="assets/brand/eis-logo.png" alt="Oregon Enterprise Information Services">
      <h1>AI Strategy Socratic Sandbox</h1>
    </div>
    <p class="tagline">Huddle. Challenge. Decide. Build your agency’s AI Adoption Strategy.</p>
  </div>
...
<section class="workspace" aria-label="Socratic workspace">
  <div class="workspace-status"><span>LOCAL WORKSPACE · V2</span><span id="saveStatus" role="status">Saved on this device</span></div>
  <section id="setupPanel" class="phase" aria-labelledby="setupTitle">
    <p class="kicker">Before you begin · Optional setup</p>
    <h2 id="setupTitle" tabindex="-1">Set the context for your strategy</h2>
    <p class="copy">Ten conversations, one agency strategy. Use your approved AI tool to challenge the group’s reasoning. People make the decisions and approve the final language.</p>
  ...
  <div class="phase" id="phasePanel" role="tabpanel" aria-labelledby="tab-1">
    ...
    <ul class="facilitator-strip">
      ...
      <li class="mini-stat"><b>Interrogate</b><span class="small">Use an enterprise-approved AI tool; bring the response back for debate.</span></li>
      <li class="mini-stat"><b>Decide</b><span class="small">Only the final group decision enters the draft.</span></li>
    </ul>
    <div class="grid">
      <div class="card">
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <p class="small">Paste this prompt into an enterprise-approved AI tool. Share only context permitted for that tool. Bring the AI response back to the group for debate.</p>
...
<footer>
  Notes are stored only in this browser on this device (local storage). Workshop content is never sent by this application. Static assets load from the host; all processing stays on your device. Use Reset to clear all notes — for example, before leaving a shared or kiosk computer.
</footer>
</div>
